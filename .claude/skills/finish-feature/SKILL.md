...
8. **Quando o usuário aprovar e pedir o merge**: o merge deve ser um **merge normal** (merge commit, preservando os commits individuais da branch) — não usar squash merge nem rebase merge.
